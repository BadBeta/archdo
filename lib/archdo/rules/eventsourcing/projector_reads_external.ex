defmodule Archdo.Rules.EventSourcing.ProjectorReadsExternal do
  ...
  @impl true
  def description, do: "Projectors must not call HTTP/external services or non-deterministic functions"
  ...
  defp find_http_calls(body, file) do
    Enum.map(AST.find_all(body, fn
      ...
      Diagnostic.warning("8.6",
        ...
        alternatives: [
          Fix.new(
            summary: "Move the HTTP call to a separate event handler that updates the projection later",
            detail:
