...
7. [Test Architecture](#7-test-architecture) — 33 rules (7.1–7.35)
...
12. [Change Economy](#12-change-economy) — 33 rules (CE-1 … CE-57)
...
- **Severity:** `warning` (volatile module call), `info` (`GenServer.call/2` implicit 5s)
